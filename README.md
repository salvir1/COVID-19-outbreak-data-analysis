...
We can use a conservative estimate of 2.5 infections for every diagnosis to get a picture of just how steep the actual infections curve looks (2.5x as steep to be precise). The green trendlines below show an estimate of new active infections for the states of Montana and Utah superimposed on graphs of diagnosed case rates.
